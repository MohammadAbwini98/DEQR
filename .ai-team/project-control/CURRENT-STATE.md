...
- Desktop automated test suite: 131 PASS in the 2026-08-09 remediation verification (historical Stage 4 checkpoint remains separate)
...
**A physical iPhone is now the only blocker for both open release gates.**
